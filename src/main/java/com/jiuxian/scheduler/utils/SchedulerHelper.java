...
import com.jiuxian.common.ConstantUtils;
...
public class SchedulerHelper {
    ...
    private Set<Integer> existJobs = new HashSet<Integer>();
     ...
     * 获得任务的jobKey
     */
    public static JobKey getJobKey(Integer jobId, String jobType) {
     ...
     * @param random
     */
    private static TriggerKey getTriggerKey(Integer jobId, String jobType, boolean random) {
     ...
     * 根据jobId和类型删除
     */
    public boolean removeJob(Integer jobId, String jobType) {
        try {
     ...
     * @return
     */
    public boolean pauseJob(Integer jobId, String jobType) {
        try {
     ...
     * @return
     */
    public Date resumeJob(Integer jobId, String jobType) {
        try {
    ...
    public void update(Integer jobId, String jobType) {
     ...
     * 马上只执行一次任务
     */
    public boolean executeOnceJob(Integer jobId, String jobType) {
        try {
    ...
    public JobDetail generateJobDetail(SysJob job) {
        ...
        return JobBuilder.newJob(JobBean.class).withIdentity(getJobKey(job))
                .usingJobData(jobDataMap).requestRecovery(true).storeDurably(true).build();
    }
